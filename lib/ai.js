...
Our mission: help people celebrate love, honour memory, and mark life's biggest moments with something timeless. Every star box we send out carries a story, and we treat it with the care and significance it deserves.
...
- A beautiful star map
- Premium keepsake presentation box

**After registration, the customer receives:**
- Digital personalised certificate (emailed instantly) - suitable for framing
...
Astronomers use scientific catalog numbers for stars, so naming is symbolic. Your chosen name is recorded in our registry, on a digital certificate, and paired with your star's unique coordinates. This is a novelty/symbolic gift service, not recognised by the IAU (International Astronomical Union). It's a meaningful, personal keepsake.

**Can I see my star in the night sky?**
Yes! Every star has real celestial coordinates. Use the interactive "Find My Star" feature on your star page - simply point your phone at the sky and follow the directions to your star. Works from any location, any time of year.

**Can I choose which star I want?**
Yes! The registration system lets you explore the actual night sky and select your own star. Double-click on any region of the sky to see available stars, then pick the one you want to name. It's a truly personal experience.
...
- Constellation
- Registry number
The certificate is beautifully designed and suitable for framing.
...
2. Enter your code from your gift box
3. Explore the night sky and pick your star
4. Give your star a name
5. Certificate emailed instantly

**What if I need help finding my star?**
Your personal star page includes an interactive sky map. Click "Find My Star" to see exactly where your star is in the night sky from your current location, at any time of year. Perfect for stargazing nights!
...
- Shipping is fast and FREE within Australia!

## Returns & Refunds
- 30-day return policy from date of receipt
- Item must be in original condition, unused, with tags and in its original packaging
- You'll need your receipt or proof of purchase
- Contact support@nameabrightstar.com to start a return - we'll send a return shipping label and instructions
...
- Refunds approved within 10 business days of receiving the return
- If more than 15 business days have passed since refund approval, contact sales@artico.net.au
- EU customers: 14-day cooling off period, no reason needed
- Exchanges: return the item first; once accepted, make a separate purchase for the new item
...
- **"I want an exchange"** - They need to return the item first (contact support@nameabrightstar.com), then make a new purchase once return is accepted.
- **"My item is damaged / wrong item received"** - Ask them to contact support@nameabrightstar.com immediately with photos so we can make it right.
