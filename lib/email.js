...
async function sendNewCode(toEmail, code) {
  ...
  const registerUrl = process.env.SERVICE_URL || 'https://register.nameabrightstar.com';
...
module.exports = { sendNewCode, sendSpellingFixConfirmation, sendRawEmail, alreadySent, logSent };
